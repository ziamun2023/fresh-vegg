...
<div className='absolute top-40 left-5 '>    
        <p className='text-center relative primary-font text-[30px]'>{Maintitle}</p>
        <p className='absolute group-hover:w-[220px] duration-500 top-10 w-[200px] left-4'><img src={image} alt="" /></p>
